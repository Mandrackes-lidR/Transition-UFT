<div id="announcement"
     class="rounded-md bg-accent text-white filter drop-shadow-lg transition transform fixed bottom-2 w-11/12 left-0 right-0 mx-auto py-3 px-4 z-50 sm:w-7/12 md:bottom-3 md:left-5 md:mx-0 md:w-5/12 lg:w-3/12"
>
